...
const SliderBanner = () => {
    ...
    return (
        <div ref={sliderRef} className="keen-slider scroll-auto mb-5 md:mb-16">
            ...
            <div className="relative keen-slider__slide h-[250px] md:h-[500px] b-0 rounded-b-[80px] md:rounded-b-[100px]">
            ...
            <div className="relative keen-slider__slide h-[250px] md:h-[500px] b-0 rounded-b-[100px]">
...
//             <img src="banner-image.jpg" alt="Banner Image" className="w-full bg-cover" />
...
//                 <Link to={'signUp'} className="bg-white text-blue-500 font-semibold py-2 px-4 rounded hover:bg-blue-500 hover:text-white">
//                     Learn More
//                 </Link>
//             </div>
//         </div>
