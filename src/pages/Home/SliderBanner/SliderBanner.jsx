...
const SliderBanner = () => {
    ...
    return (
        <div ref={sliderRef} className="keen-slider scroll-auto mb-5 md:mb-16 pt-[150px] md:pt-[200px]">
            ...
            <div className="relative keen-slider__slide h-[250px] md:h-[500px] b-0 banner">
                ...
                <div className="absolute inset-0 flex flex-col justify-center items-start ml-5 md:ml-16 md:w-4/5 text-white p-10">
                    <h1 className="text-[18px] md:text-6xl font-sans text-[#1b92c4] font-bold mb-4">Welcome to our Summer Sports School Camp</h1>
            ...
            <div className="relative keen-slider__slide h-[250px] md:h-[500px] b-0 banner">
                ...
                <div className="absolute inset-0 bg-gradient-to-l from-slate-950 to-blue-400 opacity-50"></div>
                <div className="absolute inset-0 flex flex-col justify-center items-start ml-5 md:ml-16 md:w-4/5 text-white p-10">
                    <h1 className="text-[18px] md:text-6xl font-sans text-[#1b92c4] font-bold mb-4">All-Star Summer Sports Academy</h1>
            ...
            <div className="relative keen-slider__slide h-[250px] md:h-[500px] b-0 banner">
                ...
                <div className="absolute inset-0 bg-gradient-to-l from-slate-950 to-blue-400 opacity-50"></div>
                <div className="absolute inset-0 flex flex-col justify-center items-start ml-5 md:ml-16 md:w-4/5 text-white p-10">
                    <h1 className="text-[18px] md:text-6xl font-sans text-[#1b92c4] font-bold mb-4">Sizzling Summer Sports School</h1>
            ...
            <div className="relative keen-slider__slide h-[250px] md:h-[500px] b-0 banner">
                ...
                <div className="absolute inset-0 bg-gradient-to-l from-slate-950 to-blue-400 opacity-50"></div>
                <div className="absolute inset-0 flex flex-col justify-center items-start ml-5 md:ml-16 md:w-4/5 text-white p-10">
                    <h1 className="text-[18px] md:text-6xl font-sans text-[#1b92c4] font-bold mb-4">Play, Learn, and grow Summer Sports Camp</h1>
