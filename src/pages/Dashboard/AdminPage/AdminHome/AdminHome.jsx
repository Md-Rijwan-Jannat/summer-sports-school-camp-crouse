...
const AdminHome = () => {
    ...
    return (
        <Container>
            ...
            <div className="lg:flex lg:flex-row flex-col gap-10 w-full bg-[#77b6fd] allClass2 pb-10">
                <div className="w-full lg:w-1/3  mb-5">
                    ...
                    <Box sx={{ width: '100%' }}>
                        ...
                        <CustomTabPanel value={value} index={0}>
                            <div className="flex text-gray-800 text-start flex-col items-start justify-start">
                        ...
                        <CustomTabPanel value={value} index={1}>
                            <div className="text-gray-800 flex flex-col text-start justify-start">
                ...
                <div className="flex flex-col justify-start w-full ">
                    <div className="text-5xl text-green-500 font-medium flex justify-start items-center">A<span className="text-3xl text-blue-500">dmin</span>
                    </div>
                    <div className="divider border-4 border-gray-500"></div>
                    <div className="font-bold text-[25px] text-black mb-2 flex items-center gap-2">{user?.displayName} <span className="text-blue-600"><FaCheckCircle /></span></div>
                    <div className="flex items-center flex-row gap-5 mb-3">
                        <span className="text-sm text-blue-600 font-semibold">10k flowers</span>
                    ...
                    <div className="my-5 w-200  md:w-500 md:h-200">
                        <PieChart
                            series={[
                                {
                                    data: [
                                        { id: 0, value: 10, label: 'Profit' },
                                        { id: 1, value: 15, label: 'Instructor' },
